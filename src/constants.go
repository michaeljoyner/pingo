...
const (
	...
	GPIO_V2_GET_LINE_IOCTL           = 0xc0a0df03
	...
	GPIOEVENT_REQUEST_RISING_EDGE  = 1 << 2
	GPIOEVENT_REQUEST_FALLING_EDGE = 1 << 3
	GPIOEVENT_REQUEST_BOTH_EDGES   = (1 << 2) | (1 << 3)
	...
	// v2 API flags
	GPIO_V2_LINE_FLAG_INPUT        = 1 << 0
	GPIO_V2_LINE_FLAG_EDGE_RISING  = 1 << 2
	GPIO_V2_LINE_FLAG_EDGE_FALLING = 1 << 3
)
